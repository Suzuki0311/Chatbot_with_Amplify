...
if index.message_image_id != None:
    SYSTEM_PROMPTS = [{"role": "user", "content": f"From this {index.text_language} text, identify important information such as an overview, items to be implemented, precautions, date and time, location, contact information, etc. And create a summary. If you don't have important information, don't reply about it. Finally reply in {index.user_language}."}]
else:
